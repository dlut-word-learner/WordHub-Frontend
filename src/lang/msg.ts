...
userInfo: "ユーザー情報",
    ...
    register: {
      ...
      errPrompt: "登録に失敗しました。ネットワークが正常かどうかを確認してください",
    },
    dict: {
      all: "すべての辞書",
      en: "英語辞書",
      ...
      learn: "学ぶ",
      review: "復習",
      errGetDicts: "辞書の取得に失敗しました。ネットワークが正常かどうかを確認してください",
    },
    ui: {
      errGetWords: "単語の取得に失敗しました。ネットワークが正常かどうかを確認してください",
errGetSound: "単語の音声取得に失敗しました。ネットワークが正常かどうかを確認してください",
typingToStart: "入力して開始",
goToNextWord: "次の単語に進む",
prompt: "プロンプト",
confirm: "確認",
cancel: "キャンセル",
promptGoToNextWord: "現在の単語が正しくスペルされていません。次の単語に切り替えますか？",
...
finishPrompt: "おめでとうございます。すべての単語を完了しました！",
    ...
    userInfo: {
      ...
      basic: {
        errGetInfo: "ユーザー情報の取得に失敗しました。ネットワークが正常かどうかを確認してください",
        id: "ID",
        username: "ユーザー名",
        role: "ユーザーグループ",
        normalUser: "一般ユーザー",
        ...
        errPrompt: "保存に失敗しました。ネットワークが正常かどうかを確認してください",
      },
      pwd: {
        originalPwd: "元のパスワード",
        newPasswd1: "新しいパスワード",
      ...
      avatar: {
        errGetAvatar: "アバターの取得に失敗しました。ネットワークが正常かどうかを確認してください",
        currAvatar: "現在のアバター",
      ...
      delete: {
        ...
        cancel: "キャンセル",
        prompt: "プロンプト",
        deletePrompt: "このユーザーを削除してもよろしいですか？これにより、このユーザーのすべてのデータが削除され、元に戻すことはできません。",
        inputPrompt: "パスワードとパスワードの確認を入力してください",
        diffPrompt: "パスワードが一致しません",
        wrongPwdPrompt: "パスワードが間違っています",
        successPrompt: "削除に成功しました",
        errPrompt: "削除に失敗しました。ネットワークが正常かどうかを確認してください",
      },
    },
  },
};
